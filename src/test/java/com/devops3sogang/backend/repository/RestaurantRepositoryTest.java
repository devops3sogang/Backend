...
@DataMongoTest
@Import(RestaurantCustomRepositoryImpl.class)
class RestaurantRepositoryTest {
    ...
    void search_NoFilter_NoSort() {
        // Given
        Restaurant r1 = createRestaurant("식당1", 4.5, "한식", 37.5515, 126.9410, 10);
        Restaurant r2 = createRestaurant("식당2", 4.8, "일식", 37.5516, 126.9411, 20);
    ...
    void search_NoFilter_SortByDistance() {
        // Given
        Restaurant near = createRestaurant("가까운", 4.0, "한식", 37.5506, 126.9410, 10);
        Restaurant medium = createRestaurant("중간", 4.5, "일식", 37.5511, 126.9410, 15);
        Restaurant far = createRestaurant("먼", 4.9, "중식", 37.5520, 126.9410, 20);
    ...
    void search_NoFilter_SortByRating() {
        // Given
        Restaurant low = createRestaurant("낮은평점", 4.0, "한식", 37.5515, 126.9410, 10);
        Restaurant high = createRestaurant("높은평점", 4.9, "일식", 37.5516, 126.9411, 15);
        Restaurant medium = createRestaurant("중간평점", 4.5, "중식", 37.5517, 126.9412, 20);
    ...
    void search_NoFilter_SortByPopular() {
        // Given
        Restaurant r1 = createRestaurant("식당1", 4.5, "한식", 37.5515, 126.9410, 5);
        Restaurant r2 = createRestaurant("식당2", 4.7, "일식", 37.5516, 126.9411, 20);
        Restaurant r3 = createRestaurant("식당3", 4.2, "중식", 37.5517, 126.9412, 12);
    ...
    void search_DistanceFilter_NoSort() {
        // Given
        Restaurant near = createRestaurant("가까운", 4.0, "한식", 37.5506, 126.9410, 10);
        Restaurant far = createRestaurant("먼", 4.8, "일식", 37.5600, 126.9410, 15);
    ...
    void search_DistanceFilter_SortByRating() {
        // Given
        Restaurant lowRating = createRestaurant("낮은평점", 4.0, "한식", 37.5506, 126.9410, 10);
        Restaurant highRating = createRestaurant("높은평점", 4.8, "일식", 37.5511, 126.9410, 15);
        Restaurant far = createRestaurant("먼", 4.9, "중식", 37.5600, 126.9410, 20);
    ...
    void search_DistanceFilter_SortByPopular() {
        // Given
        Restaurant lowReview = createRestaurant("리뷰적음", 4.0, "한식", 37.5506, 126.9410, 5);
        Restaurant highReview = createRestaurant("리뷰많음", 4.2, "일식", 37.5507, 126.9410, 15);
        Restaurant far = createRestaurant("먼", 4.9, "중식", 37.5600, 126.9410, 100);
    ...
    void search_CategoryFilter_NoSort() {
        // Given
        Restaurant korean1 = createRestaurant("한식1", 4.5, "한식", 37.5515, 126.9410, 10);
        Restaurant korean2 = createRestaurant("한식2", 4.3, "한식", 37.5516, 126.9411, 15);
        Restaurant japanese = createRestaurant("일식", 4.8, "일식", 37.5517, 126.9412, 20);
    ...
    void search_CategoryFilter_SortByDistance() {
        // Given
        Restaurant nearKorean = createRestaurant("가까운한식", 4.2, "한식", 37.5506, 126.9410, 10);
        Restaurant farKorean = createRestaurant("먼한식", 4.7, "한식", 37.5520, 126.9410, 15);
        Restaurant japanese = createRestaurant("일식", 4.9, "일식", 37.5505, 126.9410, 20);
    ...
    void search_CategoryFilter_SortByRating() {
        // Given
        Restaurant korean1 = createRestaurant("한식1", 4.3, "한식", 37.5515, 126.9410, 10);
        Restaurant korean2 = createRestaurant("한식2", 4.7, "한식", 37.5516, 126.9411, 15);
        Restaurant japanese = createRestaurant("일식", 4.9, "일식", 37.5517, 126.9412, 20);
        restaurantRepository.saveAll(List.of(korean1, korean2, japanese));
    ...
    void search_CategoryFilter_SortByPopular() {
        // Given
        Restaurant k1 = createRestaurant("한식1", 4.0, "한식", 37.5515, 126.9410, 3);
        Restaurant k2 = createRestaurant("한식2", 4.5, "한식", 37.5516, 126.9411, 10);
        Restaurant j1 = createRestaurant("일식", 4.8, "일식", 37.5517, 126.9412, 20);
    ...
    void search_DistanceAndCategoryFilter_NoSort() {
        // Given
        Restaurant nearKorean = createRestaurant("가까운한식", 4.2, "한식", 37.5506, 126.9410, 10);
        Restaurant farKorean = createRestaurant("먼한식", 4.7, "한식", 37.5600, 126.9410, 15);
        Restaurant nearJapanese = createRestaurant("가까운일식", 4.9, "일식", 37.5507, 126.9410, 20);
    ...
    void search_DistanceAndCategoryFilter_SortByRating() {
        // Given
        Restaurant r1 = createRestaurant("한식1", 4.2, "한식", 37.5506, 126.9410, 10);
        Restaurant r2 = createRestaurant("한식2", 4.7, "한식", 37.5511, 126.9410, 15);
        Restaurant farKorean = createRestaurant("먼한식", 4.9, "한식", 37.5600, 126.9410, 20);
        Restaurant nearJapanese = createRestaurant("일식", 4.9, "일식", 37.5507, 126.9410, 25);
    ...
    void search_DistanceAndCategoryFilter_SortByPopular() {
        // Given
        Restaurant r1 = createRestaurant("한식1", 4.0, "한식", 37.5506, 126.9410, 5);
        Restaurant r2 = createRestaurant("한식2", 4.7, "한식", 37.5507, 126.9410, 15);
        Restaurant r3 = createRestaurant("일식", 4.9, "일식", 37.5508, 126.9410, 20);
        restaurantRepository.saveAll(List.of(r1, r2, r3));
    ...
    void exception_MissingCoordinates_DistanceSort() {
        ...
        // When & Then
        assertThatThrownBy(() -> restaurantRepository.search(request))
    ...
    void exception_InactiveRestaurants_NotIncluded() {
        // Given
        Restaurant active = createRestaurant("활성", 4.5, "한식", 37.5515, 126.9410, 10);
        Restaurant inactive = createRestaurant("비활성", 4.9, "한식", 37.5516, 126.9411, 15);
    ...
    void exception_NonExistentCategory_ReturnsEmptyList() {
        // Given
        Restaurant korean = createRestaurant("한식", 4.5, "한식", 37.5515, 126.9410, 10);
        Restaurant japanese = createRestaurant("일식", 4.8, "일식", 37.5516, 126.9411, 15);
